...
describe("User authentification", () => {
  ...
  context("I am a valid user with role", () => {
    it("should fill login form and redirect to homepage", () => {
      ...
      cy.get("[data-cy=email]")
        ...
        .should("have.value", this.credentials.userTrue.email);
      cy.get("[data-cy=password]")
        .type("SW-@sowell")
        .should("have.value", this.credentials.userTrue.password);
  ...
  context("I am not a valid user", () => {
    it("should fill login form and get forbidden notification error", () => {
      ...
      cy.get("[data-cy=email]")
        .type("sw-sup@sowellapp.com")
        .should("have.value", this.credentials.userWrong.email);
      cy.get("[data-cy=password]")
        .type("123456")
        .should("have.value", this.credentials.userWrong.password);
